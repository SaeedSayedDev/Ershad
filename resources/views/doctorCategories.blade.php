                ...
                <div class="modal-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="editCatForm" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input id="editCatDisc" type="text" name="disc" class="form-control" required>
                        </div>
                          <div class="form-group">
                            <label> {{ __('Category') }}</label>
                            @php 
                            $category =  \App\Models\DoctorCategories::where('is_deleted', 0)->get();
                            @endphp
                            <select name="parent" id="editCatParent" class="form-control" required>
