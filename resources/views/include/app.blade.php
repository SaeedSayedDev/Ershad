            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sideBarli  slidersSideA">
                            <a href="{{ route('sliders') }}" class="nav-link"><i class="fas fa-tag"></i><span>
                                    {{ __('Sliders') }} </span></a>
                        </li>
                        <li class="sideBarli  interestsSideA">
                            <a href="{{ route('interests') }}" class="nav-link"><i class="fas fa-tag"></i><span>
                                    {{ __('Interests') }} </span></a>
                        </li>

                        <li class="sideBarli  interestsSideA">
                            <a href="{{ route('jobTitles') }}" class="nav-link"><i class="fas fa-tag"></i><span>
                                    {{ __('JobTitles') }} </span></a>
                        </li>
                        ...
                        <li class="sideBarli  aiSideA">
                            <a href="{{ route('ai') }}" class="nav-link">
                                <i class="fas fa-robot"></i>
                                <span>{{ __('AI') }} </span>
                            </a>
                        </li>
                        <li class="sideBarli  articlesSideA">
                            <a href="{{ route('articles') }}" class="nav-link">
                                <i class="fas fa-newspaper"></i>
                                <span>{{ __('Articles') }} </span>
                            </a>
                        </li>
                        <li class="sideBarli  packagesSideA">
                            <a href="{{ route('packages') }}" class="nav-link">
                                <i class="fas fa-box-open"></i>
                                <span>{{ __('Packages') }} </span>
                            </a>
                        </li>
                        <li class="sideBarli promotionsSideA">
                            <a href="{{ route('promotions') }}" class="nav-link">
                                <i class="fas fa-handshake"></i>
                                <span>{{ __('Doctor Promotions') }}</span>
                            </a>
                        </li>
                        <li class="sideBarli promoCodesSideA">
                        ...
                        <li class="sideBarli contactsSideA">
