        ...
        <div class="card col ml-2">
            ...
            <div id="payment-details-body" class="card-body">
                ...
                <div class="invoice-item ">
                    ...
                    <p>{{ $settings->currency }}{{ isset($orderSummary) ? $orderSummary['service_amount'] ?? '' : '' }}</p>
                </div>
                @if (isset($orderSummary) && isset($orderSummary['coupon_apply']) && $orderSummary['coupon_apply'] == 1)
                    <div class="invoice-item ">
                        <div class="d-flex">
                            <p>{{ __('Discount Amount') }}</p>
                            <p class="ml-2 bg-dark text-white coupon-text">
